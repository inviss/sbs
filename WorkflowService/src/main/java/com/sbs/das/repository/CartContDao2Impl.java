...
//@Repository(value="cartContDao2")
public class CartContDao2Impl extends SqlMapClientDaoSupport implements CartContDao2 {

	@Autowired
	public final void setSqlMapClientWorkaround(@Qualifier("sqlMapClient3") SqlMapClient sqlMapClient) { 
