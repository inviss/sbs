...
public class IsValidUserTest {
	...
	public static void main(String[] args) {
		try {
			...
			TokenDO _do = (TokenDO)_doXML.setDO("<?xml version=\"1.0\" encoding=\"utf-8\"?><das><tokeninfo><hex>80:FA:5B:1B:C8:79</hex><user_id>S522522</user_id><password>522522</password></tokeninfo></das>");
