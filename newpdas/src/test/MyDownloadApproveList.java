...
public class MyDownloadApproveList {
	...
	public static void main(String[] args) {
		...
		try {
			CartItemDO _do = (CartItemDO)_doXML.setDO("<?xml version=\"1.0\" encoding=\"utf-8\"?><das><cartItems><DOWN_SUBJ></DOWN_SUBJ><FROMDATE>20160101</FROMDATE><ENDDATE>20160108</ENDDATE><USERID>S797041</USERID><system></system></cartItems></das>");
