		...
		try {
			...
			if (_infoList2 != null && _infoList2.size() > 0) {
				...
				while (_iter2.hasNext()) {
					_doXML.setDO(_iter2.next());
					_xml.append(_doXML.getSubXML2());
				}
			}
			_xml.append("<discard>");
	...
	public String getRoleInfoList(String roleInfoDO) throws RemoteException{
		...
		try {
			...
			if (_infoList2 != null && _infoList2.size() > 0) {
				...
				while (_iter2.hasNext()) {
					_do2XML.setDO(_iter2.next());
					_xml.append(_do2XML.getSubXML());
				}
			}
			_xml.append("</authorinfo>");
	...
	public String getStorageCheck(String xml) throws Exception{
		...
		try {
			...
			if (_infoList != null && _infoList.size() > 0) {
				...
				while (_iter.hasNext()) {
					_DOXML.setDO(_iter.next());
					_xml.append(_DOXML.getStorageCheck());
				}
			}
		} catch (Exception e) {
	...
	public String insertStDownCartInfo(String downCartDO_cartContDO) throws Exception {
		...
		try {
			...
			if (_infoList != null && _infoList.size() > 0) {
				Iterator _iter = _infoList.iterator();
				while (_iter.hasNext()) {
					_doXML_cont.setDO(_iter.next());
					_xml.append(_doXML_cont.getSubXML());
				}
			} 
		}catch (Exception e) {
	...
	public String getArchiveInfo(String xml) throws Exception{
		...
		try {
			...
			if (_infoList != null && _infoList.size() > 0) {
				...
				while (_iter.hasNext()) {
					_doXML.setDO(_iter.next());
					_xml.append(_doXML.getArchiveXML());
				}
			}
		} catch (Exception e) {
	...
	public String getManualJobinfo(String xml) throws Exception{
		...
		try {
			...
			if (_infoList != null && _infoList.size() > 0) {
				...
				while (_iter.hasNext()) {
					_doXML.setDO(_iter.next());
					_xml.append(_doXML.getManualXML());
				}
			}
		} catch (Exception e) {
	...
	public String getMyArchiveRequestList(String commonDO) throws RemoteException{
		...
		try {
			...
			if(_infolist != null&&_infolist.size()!=0){
				...
				while(_iter.hasNext()){
					_DOXML.setDO(_iter.next());
					_xml.append( _DOXML.getReqListXML());
				}
			}
		} catch (Exception e) {
	...
	public String getDowninfoForIfCms(String xml) throws Exception{
		...
		try {
			...
			if (_infoList != null && _infoList.size() > 0) {
				...
				while (_iter.hasNext()) {
					_doXML.setDO(_iter.next());
					_xml.append(_doXML.getIfCmsXML());
				}
			}
		} catch (Exception e) {
	...
	public String getJobStatus(String xml) throws Exception{
		...
		try {
			...
			if (_infoList != null && _infoList.size() > 0) {
				...
				while (_iter.hasNext()) {
					_doXML.setDO(_iter.next());
					_xml.append(_doXML.getJobInfoXML());
				}
			}
		} catch (Exception e) {
