...
{
	private static Logger logger = Logger.getLogger(LoggableStatement.class);
	 ...
	 * ??u????? ??????? (singleton ????? ??????? ??쨈?)
	 */
	public static LoggableStatement getInstance(Connection connection, String sql) throws SQLException{
		LoggableStatement loggableStatement = new LoggableStatement(connection, sql);
	...
	public java.sql.ResultSet executeQuery() throws java.sql.SQLException {
		...
		ResultSet rs = wrappedStatement.executeQuery();
	...
	public java.sql.ResultSet executeQuery(String sql) throws java.sql.SQLException {
		...
		ResultSet rs = wrappedStatement.executeQuery(sql);
	...
	public int executeUpdate() throws java.sql.SQLException {
		...
		int result = wrappedStatement.executeUpdate();
