 ...
 *
 */
public class EmployeeDASRoleDOXML extends DOXml {
	/**
	 * xml 헤더
	 */
	private String XML_NODE_HEAD = "employeerole";
	/**
	 *  비직원 sbs 사용자 id
	 */
	...
	public Object setData(Element pElement) {
		EmployeeDASRoleDO employeeroleconditionDO = (EmployeeDASRoleDO)getDO();
