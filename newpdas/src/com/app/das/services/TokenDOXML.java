 ...
 *
 */
public class TokenDOXML extends DOXml{
	/**
	 * xml해더
	 */
	...
	public Object setData(Element pElement) {
		...
		for(int i = 0; i < _length; i++) {
			...
			/**
			 * token 에 대한 enc&dec 는 DO 에서 처리 한다.
			 */
	...
	public String getSubXML() {
		...
		_xml.append("<" + XML_NODE_USER_NM + ">" + CommonUtl.transXmlText(infoDO.getUser_nm()) + "</"  + XML_NODE_USER_NM + "> \n");
		_xml.append("<" + XML_NODE_ROLE_CD + ">" + infoDO.getRole_cd() + "</"  + XML_NODE_ROLE_CD + "> \n");
		...
		_xml.append("<" + XML_NODE_AUTH_RESULT + ">" + CommonUtl.transXmlText(infoDO.getAuth_result())+ "</"  + XML_NODE_AUTH_RESULT + "> \n");
