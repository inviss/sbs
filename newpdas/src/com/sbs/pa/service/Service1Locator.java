...
public class Service1Locator extends org.apache.axis.client.Service implements Service1 {
    ...
    private String Service1Soap12_address = bundle.getString("PA_MAIN_SOAP_URL");
//    private java.lang.String Service1Soap12_address = "http://10.30.25.205:8888/PAWebService/Service1.asmx";
    ...
    public Service1Soap getService1Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public Service1Soap getService1Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    private java.lang.String Service1Soap_address = "http://10.150.12.97:8888/PAWebService/Service1.asmx";
    ...
    public Service1Soap getService1Soap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public Service1Soap getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Service1SoapStub _stub = new Service1SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                Service1Soap12Stub _stub = new Service1Soap12Stub(new java.net.URL(Service1Soap12_address), this);
                _stub.setPortName(getService1Soap12WSDDServiceName());
                return _stub;
            }
            if (Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                Service1SoapStub _stub = new Service1SoapStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
